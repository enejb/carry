		...
		<div id="content" role="main">
			...
			<article id="post-0" class="post error404 not-found">
				<header class="entry-header">
					<h1 class="entry-title"><?php _e( 'Oops! That page can&rsquo;t be found.', 'carry' ); ?></h1>
				</header>
				...
				<div class="entry-content">
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'carry' ), convert_smilies( ':)' ) ) . '</p>';
