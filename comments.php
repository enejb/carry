 ...
 * handled by a callback to carry_comment() which is
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use carry_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define carry_comment() and that will be used instead.
				 * See carry_comment() in functions.php for more.
				 */
